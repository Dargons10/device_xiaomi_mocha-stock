...
void _ZNK7android10GLConsumer16getCurrentBufferEPi(void *thisPtr, int *outSlot);

void _ZNK7android10GLConsumer16getCurrentBufferEv(void *thisPtr) {
    _ZNK7android10GLConsumer16getCurrentBufferEPi(thisPtr, nullptr);
}
